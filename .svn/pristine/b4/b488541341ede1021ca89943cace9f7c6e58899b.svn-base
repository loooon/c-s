...
--%>
    ...
    <div class="from">
        ...
        <div class="from-block">
            ...
            <div class="from-block">
                <p><i><img src="/resources/img/dun/icon12.png"></i><input type="text" id="contactPhone" name="contactPhone" type="text" placeholder="请输入您的联系电话"></p>
                <p id="contactPhoneMessage" class="b1" style="display: none"><img src="/resources/img/dun/infor.png"><em>请输入正确的手机号</em></p>
            </div>
        <div class="from-block">
            <p>
    ...
    <script>
        $().ready(function () {
            ...
            $("#submitApply").click(function () {
                $("#phoneMessage,#byPhoneMessage,#fileMessage,#fileMessageSize,#resultMessage").hide();
                var phone = $("#phone").val();
                ...
                if(contactPhone == ''||(!contactPhone.isMobile()&&!contactPhone.isPhone()))
                {
                    $("#contactPhoneMessage").show();
                    $("#contactPhone").focus();
                    return;
                }
