...
) ENGINE=MYISAM DEFAULT CHARSET=utf8 COMMENT='系统用户ip表';
...
) ENGINE=MYISAM DEFAULT CHARSET=utf8 COMMENT='催收号码查询';
...
) ENGINE=MYISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='催收号码数量';
...
(
    ...
    is_delete INT(11)
) ENGINE=MYISAM DEFAULT CHARSET=utf8 COMMENT='详单号码查询记录';
...
(
    ...
    duty VARCHAR(255)
) ENGINE=MYISAM DEFAULT CHARSET=utf8 COMMENT='企业申请';
...
)ENGINE=MYISAM DEFAULT CHARSET=utf8 COMMENT='催收号码分布图';
...
) ENGINE=MYISAM DEFAULT CHARSET=utf8 COMMENT='催收号码搜索记录';
...
(
    ...
    woe DOUBLE,
    score DOUBLE
)ENGINE=MYISAM DEFAULT CHARSET=utf8 COMMENT='催收分数字典';
...
(
    ...
    vkey VARCHAR(100) COMMENT '查询机构key',
	number VARCHAR(100) COMMENT '查验的号码',
    uname VARCHAR(250) COMMENT '被查询用户名',
    phone VARCHAR(50) COMMENT '被查询手机号',
    ...
    result_code INT(11) COMMENT '查询结果编码',
...
CREATE TABLE `tb_user_grayscale_stat_variable` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MYISAM  DEFAULT CHARSET=utf8 COMMENT='染黑度统计变量';
...
CREATE TABLE tb_grayscale_variable (
  ...
  update_time datetime DEFAULT NULL,
  create_time datetime NOT NULL
) ENGINE=MYISAM DEFAULT CHARSET=utf8 COMMENT='染黑变量';