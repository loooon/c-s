 ...
 */
@Controller
public class GrayscaleOrgStatPdfController extends AbstractBaseController
{

    @RequestMapping(value = "/service", method = RequestMethod.POST, params = "t=grayscale_org_stat_report")
            ...
            HttpServletResponse response)
    {
        ...
        model.put("grayscaleOrgStat", grayscaleOrgStat);
        ...
        String text = VelocityEngineUtils.mergeTemplateIntoString(VelocityEngineUtil.getInstance(),
                "template/grayscale_org_stat.vm", "utf-8", model);
