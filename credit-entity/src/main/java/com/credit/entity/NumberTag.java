...
public class NumberTag
{
    ...
    public void setOrgType(OrganizationType orgType)
    {
        ...
        if ("高风险".equals(this.orgName))
        {
            orgClass = DemandTypeEnum.HIGH_RISK.getClassName();
        }
    ...
    public void setDemandType(DemandType demandType)
    {
        ...
        if (demandType == null)
        {
            ...
            this.demandTypeId = 0;
            this.demandClass = DemandTypeEnum.HIGH_RISK.getClassName();
        }
        else
            if (demandType.getDemandType() == 10)
            {
                ...
                this.isDun = true;
                this.demandClass = DemandTypeEnum.DUN.getClassName();
            }
            else
                if (demandType.getDemandType() == 15)
                {
                    ...
                    this.demandTypeId = demandType.getDemandType();
                    this.demandClass = DemandTypeEnum.CUSTOMER_SERVICE.getClassName();
                }
                else
                {
                    this.demandName = demandType.getDemandTypeName();
                    ...
                    this.demandTypeId = demandType.getDemandType();
                    this.demandClass = DemandTypeEnum.GENERAL.getClassName();
                }
    }
