...
public class RandomUtil
{
     ...
     * @return
     */
    public static Set<Integer> genRandomNumber(int begin, int end, long count)
    {
        Set<Integer> set = new HashSet<>();
        while (set.size() < count)
        {
            set.add(genRandomNumber(begin,end));
        }
        return set;
    }
    ...
    public static void main(String[] args)
    {
        try
        {
            System.out.println(genRandomNumber(0, 2));
            
            System.out.println(genRandomString(6));
            ...
            System.out.println("###########################");
            System.out.println(genRandomNumber(1,20,6));
        }
        catch(Exception e)
        {
            e.printStackTrace();
