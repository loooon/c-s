...
package com.credit.common.web.servlet.filter.csrf;
 ...
 * package can be created and accessed via the getManager method call. <p>The
 * StringManager will look for a ResourceBundle named by the package name given
 * plus the suffix of "LocalStrings". In practice, this means that the localized
 * information will be contained in a LocalStrings.properties file located in
 * the package directory of the classpath. <p>Please see the documentation for
