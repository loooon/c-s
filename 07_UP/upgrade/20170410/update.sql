...
INSERT INTO tb_site_resource (resource_id,resource_path,resource_name,parent_id,resource_type,update_time,create_time) VALUES ('2', '/service?t=call_detail_number_mark_report', '详单号码标记导出pdf', null, '1', '2017-04-01 16:37:17', '2017-04-01 16:37:19');
...
ALTER TABLE tb_user MODIFY  (verify_state_code INT(11) NOT NULL,user_nickname VARCHAR(255) NOT NULL);
