...
public class CallDetailUtil
{
    ...
    public static List<String> readFile(Applicant applicant,InputStream inputStream, String fileCharset) throws ServiceException
    {
        ...
        {
//            errMsgList.add("读取详单文件[" + file.getName() + "]失败:" + e.getMessage());
    ...
    public static List<String> readFile(List<CallDetails> callDetailsList,InputStream inputStream, String fileCharset) throws ServiceException{
		List<String> errMsgList = new ArrayList<String>();
		try
		{
			if (inputStream != null)
			{
				...
				for (String line : stringList)
				{
					...
					{
						errMsgList.add("解析申请人详单行内容[" + line + "]失败:" + e.getMessage());
						logger.warn("解析详单行内容[" + line + "]失败", e);
					}
...
//            errMsgList.add("读取详单文件[" + file.getName() + "]失败:" + e.getMessage());
    ...
    public static String saveFile(MultipartFile multipartFile,String uploadFilePath) throws ServiceException
    {
        ...
        // String fileDir =
        // ConfigInfo.CALL_DETAIL_UPLOAD_FILE_PATH+prefix +"/";
        String fileDir = uploadFilePath + prefix + "/";
        File dir = new File(fileDir);
        String filePath = fileDir + originFileName + "." + suffix;
        ...
        if (!file.exists())
        {
            ...
            catch (IOException e)
            {
                ...
                throw new ServiceException("保存详单文件异常");
            }
        }
        try
        {
    ...
    public static MultipartFile getMultipartFile(HttpServletRequest request,String fileCharset) throws ServiceException
    {
        CommonsMultipartResolver commonsMultipartResolver = new CommonsMultipartResolver(
                request.getSession().getServletContext());
        commonsMultipartResolver.setDefaultEncoding(fileCharset);
